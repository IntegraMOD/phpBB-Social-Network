            ...
            init: function() {
                this.each(function() {
                    var i, l, tmp, newChar, summTagless, summOpens, summCloses,
                        lastCloseTag, detailText, $thisDetails, $readMore,
                        openTagsForDetails = [],
                    ...
                    o.moreLabel = $this.find(moreClass).length ? '' : buildMoreLabel(o);
                ...
                if ( this.data('expander') ) {
                    ...
                    this.each(function() {
                        var opts = $.meta ? $.extend({}, opts, $(this).data()) : opts,
                            $this = $(this),
                            $detailsNotSummary = $this.find('.' + opts.detailClass).contents();
 
                        $this.find('.' + opts.moreClass).remove();
                        $this.find('.' + opts.summaryClass).remove();
                        $this.find('.' + opts.detailClass).after($detailsNotSummary).remove();
                        $this.find('.' + opts.lessClass).remove();
                    });
                }
            }
        };

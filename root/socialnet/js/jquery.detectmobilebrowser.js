 ...
 *
 * This function will set $.browser.mobile to true if the browser is a mobile device
 *
...
(function($) {
    ...
    // Define the mobile detection function
    ...
    // Add the mobile property to jQuery
    $.extend($, {
        browser: {
            mobile: isMobileBrowser(navigator.userAgent || navigator.vendor || window.opera)
        }
    });

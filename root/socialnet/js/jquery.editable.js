...
(function($) {
    ...
    $.fn.snEditable = function(options) {
        ...
        var methods = {
            addButton: function(obj) {
                ...
                th.children('[name=editable-button]').on('click', function() {
            ...
            editProccessStart: function(obj) {
                ...
                th.children('[name^="editable-"]').on('keypress', function(e) {
        ...
        return this.each(function(idx) {
            ...
            obj.convert = obj.edit != obj.origin;
            obj.canClose = false;
    ...
    // Make snEditable available globally
    window.$snEditable = $snEditable;
